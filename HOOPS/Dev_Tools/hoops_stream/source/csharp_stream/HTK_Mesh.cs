...
public class HTK_Mesh : TK_Mesh {
  private HandleRef swigCPtr;

  public HTK_Mesh(IntPtr cPtr, bool cMemoryOwn) : base(HCSSTREAMPINVOKE.HTK_MeshUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  public static HandleRef getCPtr(HTK_Mesh obj) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          HCSSTREAMPINVOKE.delete_HTK_Mesh(swigCPtr);
        }
  ...
  public override TK_Status Execute(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(HTK_Mesh)) ? HCSSTREAMPINVOKE.HTK_Mesh_Execute(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSSTREAMPINVOKE.HTK_Mesh_ExecuteSwigExplicitHTK_Mesh(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
  ...
  public override TK_Status Interpret(BStreamFileToolkit tk, ID_Key key, int variant) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(HTK_Mesh)) ? HCSSTREAMPINVOKE.HTK_Mesh_Interpret__SWIG_0(swigCPtr, BStreamFileToolkit.getCPtr(tk), key, variant) : HCSSTREAMPINVOKE.HTK_Mesh_InterpretSwigExplicitHTK_Mesh__SWIG_0(swigCPtr, BStreamFileToolkit.getCPtr(tk), key, variant));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override TK_Status Interpret(BStreamFileToolkit tk, ID_Key key) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(HTK_Mesh)) ? HCSSTREAMPINVOKE.HTK_Mesh_Interpret__SWIG_1(swigCPtr, BStreamFileToolkit.getCPtr(tk), key) : HCSSTREAMPINVOKE.HTK_Mesh_InterpretSwigExplicitHTK_Mesh__SWIG_1(swigCPtr, BStreamFileToolkit.getCPtr(tk), key));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override TK_Status Interpret_special(BStreamFileToolkit tk, ID_Key key, string special) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(HTK_Mesh)) ? HCSSTREAMPINVOKE.HTK_Mesh_Interpret_special(swigCPtr, BStreamFileToolkit.getCPtr(tk), key, special) : HCSSTREAMPINVOKE.HTK_Mesh_Interpret_specialSwigExplicitHTK_Mesh(swigCPtr, BStreamFileToolkit.getCPtr(tk), key, special));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override TK_Status Clone(BStreamFileToolkit tk, SWIGTYPE_p_p_BBaseOpcodeHandler handler) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(HTK_Mesh)) ? HCSSTREAMPINVOKE.HTK_Mesh_Clone(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)) : HCSSTREAMPINVOKE.HTK_Mesh_CloneSwigExplicitHTK_Mesh(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override bool Match_Instance(BStreamFileToolkit tk, Recorded_Instance instance) {
    bool ret = ((this.GetType() == typeof(HTK_Mesh)) ? HCSSTREAMPINVOKE.HTK_Mesh_Match_Instance(swigCPtr, BStreamFileToolkit.getCPtr(tk), Recorded_Instance.getCPtr(instance)) : HCSSTREAMPINVOKE.HTK_Mesh_Match_InstanceSwigExplicitHTK_Mesh(swigCPtr, BStreamFileToolkit.getCPtr(tk), Recorded_Instance.getCPtr(instance)));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public HTK_Mesh() : this(HCSSTREAMPINVOKE.new_HTK_Mesh(), true) {
    SwigDirectorConnect();
  }

  private void SwigDirectorConnect() {
    if (SwigDerivedClassHasMethod("Read", swigMethodTypes0))
      swigDelegate0 = new SwigDelegateHTK_Mesh_0(SwigDirectorRead);
    if (SwigDerivedClassHasMethod("Write", swigMethodTypes1))
      swigDelegate1 = new SwigDelegateHTK_Mesh_1(SwigDirectorWrite);
    if (SwigDerivedClassHasMethod("Execute", swigMethodTypes2))
      swigDelegate2 = new SwigDelegateHTK_Mesh_2(SwigDirectorExecute);
    if (SwigDerivedClassHasMethod("Interpret", swigMethodTypes3))
      swigDelegate3 = new SwigDelegateHTK_Mesh_3(SwigDirectorInterpret__SWIG_0);
    if (SwigDerivedClassHasMethod("Interpret", swigMethodTypes4))
      swigDelegate4 = new SwigDelegateHTK_Mesh_4(SwigDirectorInterpret__SWIG_1);
    if (SwigDerivedClassHasMethod("Interpret_special", swigMethodTypes5))
      swigDelegate5 = new SwigDelegateHTK_Mesh_5(SwigDirectorInterpret_special);
    if (SwigDerivedClassHasMethod("Reset", swigMethodTypes6))
      swigDelegate6 = new SwigDelegateHTK_Mesh_6(SwigDirectorReset);
    if (SwigDerivedClassHasMethod("Match_Instance", swigMethodTypes7))
      swigDelegate7 = new SwigDelegateHTK_Mesh_7(SwigDirectorMatch_Instance);
    if (SwigDerivedClassHasMethod("Clone", swigMethodTypes8))
      swigDelegate8 = new SwigDelegateHTK_Mesh_8(SwigDirectorClone);
    if (SwigDerivedClassHasMethod("NeedsContext", swigMethodTypes9))
      swigDelegate9 = new SwigDelegateHTK_Mesh_9(SwigDirectorNeedsContext);
    if (SwigDerivedClassHasMethod("EnumerateEdges", swigMethodTypes10))
      swigDelegate10 = new SwigDelegateHTK_Mesh_10(SwigDirectorEnumerateEdges);
    if (SwigDerivedClassHasMethod("LabelFakeEdges", swigMethodTypes11))
      swigDelegate11 = new SwigDelegateHTK_Mesh_11(SwigDirectorLabelFakeEdges);
    if (SwigDerivedClassHasMethod("AllowInstancing", swigMethodTypes12))
      swigDelegate12 = new SwigDelegateHTK_Mesh_12(SwigDirectorAllowInstancing);
    if (SwigDerivedClassHasMethod("read_trivial_points", swigMethodTypes13))
      swigDelegate13 = new SwigDelegateHTK_Mesh_13(SwigDirectorread_trivial_points);
    if (SwigDerivedClassHasMethod("write_trivial_points", swigMethodTypes14))
      swigDelegate14 = new SwigDelegateHTK_Mesh_14(SwigDirectorwrite_trivial_points);
    if (SwigDerivedClassHasMethod("read_collection", swigMethodTypes15))
      swigDelegate15 = new SwigDelegateHTK_Mesh_15(SwigDirectorread_collection);
    if (SwigDerivedClassHasMethod("write_collection_3arg", swigMethodTypes16))
      swigDelegate16 = new SwigDelegateHTK_Mesh_16(SwigDirectorwrite_collection_3arg);
    if (SwigDerivedClassHasMethod("write_collection_2arg", swigMethodTypes17))
      swigDelegate17 = new SwigDelegateHTK_Mesh_17(SwigDirectorwrite_collection_2arg);
    if (SwigDerivedClassHasMethod("write_collection", swigMethodTypes18))
      swigDelegate18 = new SwigDelegateHTK_Mesh_18(SwigDirectorwrite_collection);
    if (SwigDerivedClassHasMethod("read_trivial_points_ascii", swigMethodTypes19))
      swigDelegate19 = new SwigDelegateHTK_Mesh_19(SwigDirectorread_trivial_points_ascii);
    if (SwigDerivedClassHasMethod("write_trivial_points_ascii", swigMethodTypes20))
      swigDelegate20 = new SwigDelegateHTK_Mesh_20(SwigDirectorwrite_trivial_points_ascii);
    if (SwigDerivedClassHasMethod("read_collection_ascii", swigMethodTypes21))
      swigDelegate21 = new SwigDelegateHTK_Mesh_21(SwigDirectorread_collection_ascii);
    if (SwigDerivedClassHasMethod("write_vertex_marker_sizes_ascii", swigMethodTypes22))
      swigDelegate22 = new SwigDelegateHTK_Mesh_22(SwigDirectorwrite_vertex_marker_sizes_ascii);
    if (SwigDerivedClassHasMethod("write_collection_ascii_3arg", swigMethodTypes23))
      swigDelegate23 = new SwigDelegateHTK_Mesh_23(SwigDirectorwrite_collection_ascii_3arg);
    if (SwigDerivedClassHasMethod("write_collection_ascii_2arg", swigMethodTypes24))
      swigDelegate24 = new SwigDelegateHTK_Mesh_24(SwigDirectorwrite_collection_ascii_2arg);
    if (SwigDerivedClassHasMethod("write_collection_ascii", swigMethodTypes25))
      swigDelegate25 = new SwigDelegateHTK_Mesh_25(SwigDirectorwrite_collection_ascii);
    HCSSTREAMPINVOKE.HTK_Mesh_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9, swigDelegate10, swigDelegate11, swigDelegate12, swigDelegate13, swigDelegate14, swigDelegate15, swigDelegate16, swigDelegate17, swigDelegate18, swigDelegate19, swigDelegate20, swigDelegate21, swigDelegate22, swigDelegate23, swigDelegate24, swigDelegate25);
  }

  private bool SwigDerivedClassHasMethod(string methodName, Type[] methodTypes) {
    System.Reflection.MethodInfo methodInfo = this.GetType().GetMethod(methodName, System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance, null, methodTypes, null);
    bool hasDerivedMethod = methodInfo.DeclaringType.IsSubclassOf(typeof(HTK_Mesh));
  ...
  public delegate int SwigDelegateHTK_Mesh_0(IntPtr tk);
  public delegate int SwigDelegateHTK_Mesh_1(IntPtr tk);
  public delegate int SwigDelegateHTK_Mesh_2(IntPtr tk);
  public delegate int SwigDelegateHTK_Mesh_3(IntPtr tk, ID_Key key, int variant);
  public delegate int SwigDelegateHTK_Mesh_4(IntPtr tk, ID_Key key);
  public delegate int SwigDelegateHTK_Mesh_5(IntPtr tk, ID_Key key, string special);
  public delegate void SwigDelegateHTK_Mesh_6();
  public delegate bool SwigDelegateHTK_Mesh_7(IntPtr tk, IntPtr instance);
  public delegate int SwigDelegateHTK_Mesh_8(IntPtr tk, IntPtr handler);
  public delegate bool SwigDelegateHTK_Mesh_9(IntPtr tk);
  public delegate int SwigDelegateHTK_Mesh_10();
  public delegate int SwigDelegateHTK_Mesh_11();
  public delegate bool SwigDelegateHTK_Mesh_12(IntPtr tk);
  public delegate int SwigDelegateHTK_Mesh_13(IntPtr tk);
  public delegate int SwigDelegateHTK_Mesh_14(IntPtr tk);
  public delegate int SwigDelegateHTK_Mesh_15(IntPtr tk);
  public delegate int SwigDelegateHTK_Mesh_16(IntPtr tk, bool write_tag, int variant);
  public delegate int SwigDelegateHTK_Mesh_17(IntPtr tk, bool write_tag);
  public delegate int SwigDelegateHTK_Mesh_18(IntPtr tk);
  public delegate int SwigDelegateHTK_Mesh_19(IntPtr tk);
  public delegate int SwigDelegateHTK_Mesh_20(IntPtr tk);
  public delegate int SwigDelegateHTK_Mesh_21(IntPtr tk);
  public delegate int SwigDelegateHTK_Mesh_22(IntPtr tk);
  public delegate int SwigDelegateHTK_Mesh_23(IntPtr tk, bool write_tag, int variant);
  public delegate int SwigDelegateHTK_Mesh_24(IntPtr tk, bool write_tag);
  public delegate int SwigDelegateHTK_Mesh_25(IntPtr tk);

  private SwigDelegateHTK_Mesh_0 swigDelegate0;
  private SwigDelegateHTK_Mesh_1 swigDelegate1;
  private SwigDelegateHTK_Mesh_2 swigDelegate2;
  private SwigDelegateHTK_Mesh_3 swigDelegate3;
  private SwigDelegateHTK_Mesh_4 swigDelegate4;
  private SwigDelegateHTK_Mesh_5 swigDelegate5;
  private SwigDelegateHTK_Mesh_6 swigDelegate6;
  private SwigDelegateHTK_Mesh_7 swigDelegate7;
  private SwigDelegateHTK_Mesh_8 swigDelegate8;
  private SwigDelegateHTK_Mesh_9 swigDelegate9;
  private SwigDelegateHTK_Mesh_10 swigDelegate10;
  private SwigDelegateHTK_Mesh_11 swigDelegate11;
  private SwigDelegateHTK_Mesh_12 swigDelegate12;
  private SwigDelegateHTK_Mesh_13 swigDelegate13;
  private SwigDelegateHTK_Mesh_14 swigDelegate14;
  private SwigDelegateHTK_Mesh_15 swigDelegate15;
  private SwigDelegateHTK_Mesh_16 swigDelegate16;
  private SwigDelegateHTK_Mesh_17 swigDelegate17;
  private SwigDelegateHTK_Mesh_18 swigDelegate18;
  private SwigDelegateHTK_Mesh_19 swigDelegate19;
  private SwigDelegateHTK_Mesh_20 swigDelegate20;
  private SwigDelegateHTK_Mesh_21 swigDelegate21;
  private SwigDelegateHTK_Mesh_22 swigDelegate22;
  private SwigDelegateHTK_Mesh_23 swigDelegate23;
  private SwigDelegateHTK_Mesh_24 swigDelegate24;
  private SwigDelegateHTK_Mesh_25 swigDelegate25;
