...
public class TK_Callback : BBaseOpcodeHandler {
  ...
  public TK_Callback(IntPtr cPtr, bool cMemoryOwn) : base(HCSSTREAMPINVOKE.TK_CallbackUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  public static HandleRef getCPtr(TK_Callback obj) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          HCSSTREAMPINVOKE.delete_TK_Callback(swigCPtr);
        }
  ...
  public TK_Callback() : this(HCSSTREAMPINVOKE.new_TK_Callback(), true) {
    SwigDirectorConnect();
  }

  public override TK_Status Read(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Callback)) ? HCSSTREAMPINVOKE.TK_Callback_Read(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSSTREAMPINVOKE.TK_Callback_ReadSwigExplicitTK_Callback(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
  ...
  public override TK_Status Write(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Callback)) ? HCSSTREAMPINVOKE.TK_Callback_Write(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSSTREAMPINVOKE.TK_Callback_WriteSwigExplicitTK_Callback(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override TK_Status Clone(BStreamFileToolkit tk, SWIGTYPE_p_p_BBaseOpcodeHandler handler) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Callback)) ? HCSSTREAMPINVOKE.TK_Callback_Clone(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)) : HCSSTREAMPINVOKE.TK_Callback_CloneSwigExplicitTK_Callback(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status ReadAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSSTREAMPINVOKE.TK_Callback_ReadAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status WriteAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSSTREAMPINVOKE.TK_Callback_WriteAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override void Reset() {
    if (this.GetType() == typeof(TK_Callback)) HCSSTREAMPINVOKE.TK_Callback_Reset(swigCPtr); else HCSSTREAMPINVOKE.TK_Callback_ResetSwigExplicitTK_Callback(swigCPtr);
  }

  public void SetCallback(string callback) {
    HCSSTREAMPINVOKE.TK_Callback_SetCallback__SWIG_0(swigCPtr, callback);
  }

  public void SetCallback(int length) {
    HCSSTREAMPINVOKE.TK_Callback_SetCallback__SWIG_1(swigCPtr, length);
  }

  public string GetCallback() {return HCSSTREAMPINVOKE.TK_Callback_GetCallback__SWIG_0(swigCPtr);}
  ...
  private void SwigDirectorConnect() {
    ...
    HCSSTREAMPINVOKE.TK_Callback_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9);
  }
  ...
  public delegate int SwigDelegateTK_Callback_3(IntPtr tk, ID_Key key, int variant);
  public delegate int SwigDelegateTK_Callback_4(IntPtr tk, ID_Key key);
  public delegate int SwigDelegateTK_Callback_5(IntPtr tk, ID_Key key, string special);
