...
public class TK_PolyPolypoint : BBaseOpcodeHandler {
  ...
  public TK_PolyPolypoint(IntPtr cPtr, bool cMemoryOwn) : base(HCSSTREAMPINVOKE.TK_PolyPolypointUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  public static HandleRef getCPtr(TK_PolyPolypoint obj) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          HCSSTREAMPINVOKE.delete_TK_PolyPolypoint(swigCPtr);
        }
  ...
  public TK_PolyPolypoint(byte opcode) : this(HCSSTREAMPINVOKE.new_TK_PolyPolypoint(opcode), true) {
    SwigDirectorConnect();
  }

  public override TK_Status Read(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_PolyPolypoint)) ? HCSSTREAMPINVOKE.TK_PolyPolypoint_Read(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSSTREAMPINVOKE.TK_PolyPolypoint_ReadSwigExplicitTK_PolyPolypoint(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
  ...
  public override TK_Status Write(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_PolyPolypoint)) ? HCSSTREAMPINVOKE.TK_PolyPolypoint_Write(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSSTREAMPINVOKE.TK_PolyPolypoint_WriteSwigExplicitTK_PolyPolypoint(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override TK_Status Clone(BStreamFileToolkit tk, SWIGTYPE_p_p_BBaseOpcodeHandler handler) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_PolyPolypoint)) ? HCSSTREAMPINVOKE.TK_PolyPolypoint_Clone(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)) : HCSSTREAMPINVOKE.TK_PolyPolypoint_CloneSwigExplicitTK_PolyPolypoint(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status ReadAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSSTREAMPINVOKE.TK_PolyPolypoint_ReadAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status WriteAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSSTREAMPINVOKE.TK_PolyPolypoint_WriteAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override TK_Status Execute(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_PolyPolypoint)) ? HCSSTREAMPINVOKE.TK_PolyPolypoint_Execute(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSSTREAMPINVOKE.TK_PolyPolypoint_ExecuteSwigExplicitTK_PolyPolypoint(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override void Reset() {
    if (this.GetType() == typeof(TK_PolyPolypoint)) HCSSTREAMPINVOKE.TK_PolyPolypoint_Reset(swigCPtr); else HCSSTREAMPINVOKE.TK_PolyPolypoint_ResetSwigExplicitTK_PolyPolypoint(swigCPtr);
  }

  public TK_Status SetPoints(int point_count, float[] points) {
    TK_Status ret = (TK_Status)HCSSTREAMPINVOKE.TK_PolyPolypoint_SetPoints__SWIG_0(swigCPtr, point_count, points);
    return ret;
  }
  ...
  public TK_Status SetDPoints(int point_count, double[] points) {
    TK_Status ret = (TK_Status)HCSSTREAMPINVOKE.TK_PolyPolypoint_SetDPoints__SWIG_0(swigCPtr, point_count, points);
    return ret;
  }

  public TK_Status SetDPoints(int point_count) {
    TK_Status ret = (TK_Status)HCSSTREAMPINVOKE.TK_PolyPolypoint_SetDPoints__SWIG_1(swigCPtr, point_count);
    return ret;
  }

  public TK_Status SetLengths(int primitive_count, int[] lengths) {
    TK_Status ret = (TK_Status)HCSSTREAMPINVOKE.TK_PolyPolypoint_SetLengths__SWIG_0(swigCPtr, primitive_count, lengths);
    return ret;
  }

  public TK_Status SetLengths(int primitive_count) {
    TK_Status ret = (TK_Status)HCSSTREAMPINVOKE.TK_PolyPolypoint_SetLengths__SWIG_1(swigCPtr, primitive_count);
    return ret;
  }
  ...
  private void SwigDirectorConnect() {
    ...
    HCSSTREAMPINVOKE.TK_PolyPolypoint_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9);
  }
  ...
  public delegate int SwigDelegateTK_PolyPolypoint_3(IntPtr tk, ID_Key key, int variant);
  public delegate int SwigDelegateTK_PolyPolypoint_4(IntPtr tk, ID_Key key);
  public delegate int SwigDelegateTK_PolyPolypoint_5(IntPtr tk, ID_Key key, string special);
