...
#ifndef SWIG_HCSSTREAM_WRAP_H_
#define SWIG_HCSSTREAM_WRAP_H_

class SwigDirector_BBaseOpcodeHandler : public BBaseOpcodeHandler, public Swig::Director {

public:
    SwigDirector_BBaseOpcodeHandler(int op);
    ...
    typedef int (SWIGSTDCALL* SWIG_Callback3_t)(void *, ID_Key, int);
    typedef int (SWIGSTDCALL* SWIG_Callback4_t)(void *, ID_Key);
    typedef int (SWIGSTDCALL* SWIG_Callback5_t)(void *, ID_Key, char *);
...
public:
    SwigDirector_HTK_Close_Segment();
...
public:
    SwigDirector_HTK_Referenced_Segment(char opcode);
...
public:
    SwigDirector_HTK_Instance(int from_index = 0, int from_variant = 0, int to_index = 0, int to_variant = 0, int options = 0, float const *xform = 0);
...
public:
    SwigDirector_HTK_Delete_Object();
...
public:
    SwigDirector_HTK_Renumber(unsigned char opcode, HC_KEY key = 0);
...
public:
    SwigDirector_HTK_Color(int mask = 0, int channels = 0);
...
public:
    SwigDirector_HTK_Color_RGB(int mask = 0, float const *rgb = 0);
...
public:
    SwigDirector_HTK_Color_By_Value();
...
public:
    SwigDirector_HTK_Color_By_Index(unsigned char opcode, int mask = 0, int index = 0);
...
public:
    SwigDirector_HTK_Color_By_FIndex(int mask = 0, float index = 0.0);
...
public:
    SwigDirector_HTK_Selectability();
...
public:
    SwigDirector_HTK_Matrix(unsigned char opcode);
...
public:
    SwigDirector_HTK_Enumerated(unsigned char opcode);
...
public:
    SwigDirector_HTK_Size(unsigned char opcode);
...
public:
    SwigDirector_HTK_Linear_Pattern(unsigned char opcode);
...
public:
    SwigDirector_HTK_Named(unsigned char opcode);
...
public:
    SwigDirector_HTK_Unicode_Options();
...
public:
    SwigDirector_HTK_Camera(unsigned char opcode = TKE_Camera);
...
public:
    SwigDirector_HTK_Clip_Rectangle();
...
public:
    SwigDirector_HTK_Bounding(unsigned char opcode);
    SwigDirector_HTK_Bounding(unsigned char opcode, float *min, float *max);
    SwigDirector_HTK_Bounding(unsigned char opcode, float *center, float radius);
...
public:
    SwigDirector_HTK_Point(unsigned char opcode);
...
public:
    SwigDirector_HTK_Line(unsigned char opcode = TKE_Line);
...
public:
    SwigDirector_HTK_Polypoint(unsigned char opcode);
...
public:
    SwigDirector_HTK_NURBS_Surface();
...
public:
    SwigDirector_HTK_Circle(unsigned char opcode);
...
public:
    SwigDirector_HTK_Ellipse(unsigned char opcode);
...
public:
    SwigDirector_HTK_Text(unsigned char opcode);
...
public:
    SwigDirector_HTK_Texture_Definitions(bool shader = false);
...
public:
    SwigDirector_HTK_Glyph_Definition();
...
public:
    SwigDirector_HTK_Glyph_Definitions();
...
public:
    ...
    typedef int (SWIGSTDCALL* SWIG_Callback24_t)(void *, unsigned int);
    typedef int (SWIGSTDCALL* SWIG_Callback25_t)(void *);
    typedef int (SWIGSTDCALL* SWIG_Callback26_t)(void *, void *, int, float *);
...
private:
    ...
    SWIG_Callback24_t swig_callbackwrite_collection_ascii_2arg;
    SWIG_Callback25_t swig_callbackwrite_collection_ascii;
    SWIG_Callback26_t swig_callbackUsefulness;
    void swig_init_callbacks();
};
...
public:
    SwigDirector_HTK_PolyPolypoint(unsigned char op);
