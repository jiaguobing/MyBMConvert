...
public class TK_Window : BBaseOpcodeHandler {
  ...
  public TK_Window(IntPtr cPtr, bool cMemoryOwn) : base(HCSSTREAMPINVOKE.TK_WindowUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  public static HandleRef getCPtr(TK_Window obj) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          HCSSTREAMPINVOKE.delete_TK_Window(swigCPtr);
        }
  ...
  public TK_Window() : this(HCSSTREAMPINVOKE.new_TK_Window(), true) {
    SwigDirectorConnect();
  }

  public override TK_Status Read(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Window)) ? HCSSTREAMPINVOKE.TK_Window_Read(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSSTREAMPINVOKE.TK_Window_ReadSwigExplicitTK_Window(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
  ...
  public override TK_Status Write(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Window)) ? HCSSTREAMPINVOKE.TK_Window_Write(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSSTREAMPINVOKE.TK_Window_WriteSwigExplicitTK_Window(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override TK_Status Clone(BStreamFileToolkit tk, SWIGTYPE_p_p_BBaseOpcodeHandler handler) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Window)) ? HCSSTREAMPINVOKE.TK_Window_Clone(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)) : HCSSTREAMPINVOKE.TK_Window_CloneSwigExplicitTK_Window(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status ReadAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSSTREAMPINVOKE.TK_Window_ReadAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status WriteAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSSTREAMPINVOKE.TK_Window_WriteAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void SetWindow(float l, float r, float b, float t) {
    HCSSTREAMPINVOKE.TK_Window_SetWindow__SWIG_0(swigCPtr, l, r, b, t);
  }

  public void SetWindow(float[] w) {
    HCSSTREAMPINVOKE.TK_Window_SetWindow__SWIG_1(swigCPtr, w);
  }

  public IntPtr GetWindow() {return HCSSTREAMPINVOKE.TK_Window_GetWindow(swigCPtr);}
  ...
  private void SwigDirectorConnect() {
    ...
    HCSSTREAMPINVOKE.TK_Window_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9);
  }
  ...
  public delegate int SwigDelegateTK_Window_3(IntPtr tk, ID_Key key, int variant);
  public delegate int SwigDelegateTK_Window_4(IntPtr tk, ID_Key key);
  public delegate int SwigDelegateTK_Window_5(IntPtr tk, ID_Key key, string special);
