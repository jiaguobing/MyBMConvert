...
public class TK_Area_Light : BBaseOpcodeHandler {
  ...
  public TK_Area_Light(IntPtr cPtr, bool cMemoryOwn) : base(HCSSTREAMPINVOKE.TK_Area_LightUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  public static HandleRef getCPtr(TK_Area_Light obj) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          HCSSTREAMPINVOKE.delete_TK_Area_Light(swigCPtr);
        }
  ...
  public TK_Area_Light() : this(HCSSTREAMPINVOKE.new_TK_Area_Light(), true) {
    SwigDirectorConnect();
  }

  public override TK_Status Read(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Area_Light)) ? HCSSTREAMPINVOKE.TK_Area_Light_Read(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSSTREAMPINVOKE.TK_Area_Light_ReadSwigExplicitTK_Area_Light(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
  ...
  public TK_Status WriteAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSSTREAMPINVOKE.TK_Area_Light_WriteAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override void Reset() {
    if (this.GetType() == typeof(TK_Area_Light)) HCSSTREAMPINVOKE.TK_Area_Light_Reset(swigCPtr); else HCSSTREAMPINVOKE.TK_Area_Light_ResetSwigExplicitTK_Area_Light(swigCPtr);
  }

  public void SetPoints(int count, float[] points) {
    HCSSTREAMPINVOKE.TK_Area_Light_SetPoints__SWIG_0(swigCPtr, count, points);
  }

  public void SetPoints(int count) {
    HCSSTREAMPINVOKE.TK_Area_Light_SetPoints__SWIG_1(swigCPtr, count);
  }

  public IntPtr GetPoints() {return HCSSTREAMPINVOKE.TK_Area_Light_GetPoints__SWIG_0(swigCPtr);}

  public void SetDPoints(int count, double[] points) {
    HCSSTREAMPINVOKE.TK_Area_Light_SetDPoints__SWIG_0(swigCPtr, count, points);
  }

  public void SetDPoints(int count) {
    HCSSTREAMPINVOKE.TK_Area_Light_SetDPoints__SWIG_1(swigCPtr, count);
  }

  public IntPtr GetDPoints() {return HCSSTREAMPINVOKE.TK_Area_Light_GetDPoints__SWIG_0(swigCPtr);}

  public int GetCount() {
    int ret = HCSSTREAMPINVOKE.TK_Area_Light_GetCount(swigCPtr);
    return ret;
  }

  public void SetOptions(int o) {
    HCSSTREAMPINVOKE.TK_Area_Light_SetOptions(swigCPtr, o);
  }

  public int GetOptions() {
    int ret = HCSSTREAMPINVOKE.TK_Area_Light_GetOptions(swigCPtr);
    return ret;
  }
  ...
  private void SwigDirectorConnect() {
    ...
    HCSSTREAMPINVOKE.TK_Area_Light_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9);
  }
  ...
  public delegate int SwigDelegateTK_Area_Light_3(IntPtr tk, ID_Key key, int variant);
  public delegate int SwigDelegateTK_Area_Light_4(IntPtr tk, ID_Key key);
  public delegate int SwigDelegateTK_Area_Light_5(IntPtr tk, ID_Key key, string special);
