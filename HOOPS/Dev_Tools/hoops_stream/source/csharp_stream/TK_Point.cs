...
public class TK_Point : BBaseOpcodeHandler {
  ...
  public TK_Point(IntPtr cPtr, bool cMemoryOwn) : base(HCSSTREAMPINVOKE.TK_PointUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  public static HandleRef getCPtr(TK_Point obj) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          HCSSTREAMPINVOKE.delete_TK_Point(swigCPtr);
        }
  ...
  public TK_Point(byte opcode) : this(HCSSTREAMPINVOKE.new_TK_Point(opcode), true) {
    SwigDirectorConnect();
  }

  public override TK_Status Read(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Point)) ? HCSSTREAMPINVOKE.TK_Point_Read(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSSTREAMPINVOKE.TK_Point_ReadSwigExplicitTK_Point(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
  ...
  public override TK_Status Write(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Point)) ? HCSSTREAMPINVOKE.TK_Point_Write(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSSTREAMPINVOKE.TK_Point_WriteSwigExplicitTK_Point(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override TK_Status Clone(BStreamFileToolkit tk, SWIGTYPE_p_p_BBaseOpcodeHandler handler) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Point)) ? HCSSTREAMPINVOKE.TK_Point_Clone(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)) : HCSSTREAMPINVOKE.TK_Point_CloneSwigExplicitTK_Point(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status ReadAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSSTREAMPINVOKE.TK_Point_ReadAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status WriteAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSSTREAMPINVOKE.TK_Point_WriteAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override void Reset() {
    if (this.GetType() == typeof(TK_Point)) HCSSTREAMPINVOKE.TK_Point_Reset(swigCPtr); else HCSSTREAMPINVOKE.TK_Point_ResetSwigExplicitTK_Point(swigCPtr);
  }

  public void SetPoint(float x, float y, float z) {
    HCSSTREAMPINVOKE.TK_Point_SetPoint__SWIG_0(swigCPtr, x, y, z);
  }

  public void SetPoint(float[] p) {
    HCSSTREAMPINVOKE.TK_Point_SetPoint__SWIG_1(swigCPtr, p);
  }

  public IntPtr GetPoint() {return HCSSTREAMPINVOKE.TK_Point_GetPoint(swigCPtr);}

  public void SetDPoint(double x, double y, double z) {
    HCSSTREAMPINVOKE.TK_Point_SetDPoint__SWIG_0(swigCPtr, x, y, z);
  }

  public void SetDPoint(double[] p) {
    HCSSTREAMPINVOKE.TK_Point_SetDPoint__SWIG_1(swigCPtr, p);
  }

  public IntPtr GetDPoint() {return HCSSTREAMPINVOKE.TK_Point_GetDPoint(swigCPtr);}

  public void SetOptions(int o) {
    HCSSTREAMPINVOKE.TK_Point_SetOptions(swigCPtr, o);
  }

  public int GetOptions() {
    int ret = HCSSTREAMPINVOKE.TK_Point_GetOptions(swigCPtr);
    return ret;
  }
  ...
  private void SwigDirectorConnect() {
    ...
    HCSSTREAMPINVOKE.TK_Point_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9);
  }
  ...
  public delegate int SwigDelegateTK_Point_3(IntPtr tk, ID_Key key, int variant);
  public delegate int SwigDelegateTK_Point_4(IntPtr tk, ID_Key key);
  public delegate int SwigDelegateTK_Point_5(IntPtr tk, ID_Key key, string special);
