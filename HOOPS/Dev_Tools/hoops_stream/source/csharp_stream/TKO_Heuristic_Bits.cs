...
public enum TKO_Heuristic_Bits : uint {
  ...
  TKO_Heuristic_Force_Defer = 0x04000000,
  TKO_Heuristic_Model_Type = 0x08000000,
  TKO_Heuristic_Selection_Culling = 0x10000000,
  ...
  TKO_Heur_View_Frustum_Culling = 0x00000001,
  TKO_Heur_Obscuration_Culling = 0x00000002,
  TKO_Heur_Extent_Culling = 0x00000004,
  TKO_Heur_View_Frustum_Culling_Off = 0x00000010,
  TKO_Heur_Obscuration_Culling_Off = 0x00000020,
  TKO_Heur_Extent_Culling_Off = 0x00000040,
  TKO_Heur_Culling_Extended = 0x00000080,
  TKO_Heur_Culling_Extended_Mask = 0xFFFFFF00,
  TKO_Heur_Culling_Extended_Shift = 8,
  TKO_Heur_Obscuration_Use_Octree = 0x00000100,
  TKO_Heur_Maximum_Extent_Mode = 0x00000200,
  TKO_Heur_Vector_Culling = 0x00000400,
  TKO_Heur_Vector_Tolerance = 0x00000800,
  TKO_Heur_Vector_Culling_Off = 0x00001000,
  TKO_Heur_Vector_Tolerance_Off = 0x00002000,
  TKO_Heur_Hard_Extent_Culling = 0x00004000,
  TKO_Heur_Culling_Extended2 = 0x00008000,
  TKO_Heur_Culling_Extended2_Mask = 0xFFFF0000,
  TKO_Heur_Culling_Extended2_Shift = 16,
  TKO_Heur_Maximum_Extent_Level = 0x00010000,
  TKO_Heur_Hard_Extent_Culling_Off = 0x00020000,
  TKO_Heur_Extent_Culling_Detail_On = 0x00040000,
  TKO_Heur_Extent_Culling_Detail_Off = 0x00080000,
  TKO_Heur_Max_Distance_Culling = 0x00100000,
  TKO_Heur_Max_Distance_Culling_Off = 0x00200000,
  TKO_Heur_View_Volume_Culling = 0x00400000,
  TKO_Heur_View_Volume_Culling_Off = 0x00800000,
  ...
  TKO_Heur_Max_Extent_Level_None = 0x00,
  TKO_Heur_Max_Extent_Level_Segment = 0x01,
  TKO_Heur_Max_Extent_Level_Geometry = 0x02,
  TKO_Heur_Max_Extent_Level_Primitive = 0x04,
  TKO_Heur_Max_Extent_Level_All = 0x07,
  ...
  TKO_Heur_Model_Type_Default = 0,
  TKO_Heur_Model_Type_LMV = 1
}
