...
public class HTK_NURBS_Surface : TK_NURBS_Surface {
  private HandleRef swigCPtr;

  public HTK_NURBS_Surface(IntPtr cPtr, bool cMemoryOwn) : base(HCSSTREAMPINVOKE.HTK_NURBS_SurfaceUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  public static HandleRef getCPtr(HTK_NURBS_Surface obj) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          HCSSTREAMPINVOKE.delete_HTK_NURBS_Surface(swigCPtr);
        }
  ...
  public override TK_Status Interpret(BStreamFileToolkit tk, ID_Key key, int variant) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(HTK_NURBS_Surface)) ? HCSSTREAMPINVOKE.HTK_NURBS_Surface_Interpret__SWIG_0(swigCPtr, BStreamFileToolkit.getCPtr(tk), key, variant) : HCSSTREAMPINVOKE.HTK_NURBS_Surface_InterpretSwigExplicitHTK_NURBS_Surface__SWIG_0(swigCPtr, BStreamFileToolkit.getCPtr(tk), key, variant));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override TK_Status Interpret(BStreamFileToolkit tk, ID_Key key) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(HTK_NURBS_Surface)) ? HCSSTREAMPINVOKE.HTK_NURBS_Surface_Interpret__SWIG_1(swigCPtr, BStreamFileToolkit.getCPtr(tk), key) : HCSSTREAMPINVOKE.HTK_NURBS_Surface_InterpretSwigExplicitHTK_NURBS_Surface__SWIG_1(swigCPtr, BStreamFileToolkit.getCPtr(tk), key));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public override TK_Status Clone(BStreamFileToolkit tk, SWIGTYPE_p_p_BBaseOpcodeHandler handler) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(HTK_NURBS_Surface)) ? HCSSTREAMPINVOKE.HTK_NURBS_Surface_Clone(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)) : HCSSTREAMPINVOKE.HTK_NURBS_Surface_CloneSwigExplicitHTK_NURBS_Surface(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public HTK_NURBS_Surface() : this(HCSSTREAMPINVOKE.new_HTK_NURBS_Surface(), true) {
    SwigDirectorConnect();
  }

  private void SwigDirectorConnect() {
    if (SwigDerivedClassHasMethod("Read", swigMethodTypes0))
      swigDelegate0 = new SwigDelegateHTK_NURBS_Surface_0(SwigDirectorRead);
    if (SwigDerivedClassHasMethod("Write", swigMethodTypes1))
      swigDelegate1 = new SwigDelegateHTK_NURBS_Surface_1(SwigDirectorWrite);
    if (SwigDerivedClassHasMethod("Execute", swigMethodTypes2))
      swigDelegate2 = new SwigDelegateHTK_NURBS_Surface_2(SwigDirectorExecute);
    if (SwigDerivedClassHasMethod("Interpret", swigMethodTypes3))
      swigDelegate3 = new SwigDelegateHTK_NURBS_Surface_3(SwigDirectorInterpret__SWIG_0);
    if (SwigDerivedClassHasMethod("Interpret", swigMethodTypes4))
      swigDelegate4 = new SwigDelegateHTK_NURBS_Surface_4(SwigDirectorInterpret__SWIG_1);
    if (SwigDerivedClassHasMethod("Interpret_special", swigMethodTypes5))
      swigDelegate5 = new SwigDelegateHTK_NURBS_Surface_5(SwigDirectorInterpret_special);
    if (SwigDerivedClassHasMethod("Reset", swigMethodTypes6))
      swigDelegate6 = new SwigDelegateHTK_NURBS_Surface_6(SwigDirectorReset);
    if (SwigDerivedClassHasMethod("Match_Instance", swigMethodTypes7))
      swigDelegate7 = new SwigDelegateHTK_NURBS_Surface_7(SwigDirectorMatch_Instance);
    if (SwigDerivedClassHasMethod("Clone", swigMethodTypes8))
      swigDelegate8 = new SwigDelegateHTK_NURBS_Surface_8(SwigDirectorClone);
    if (SwigDerivedClassHasMethod("NeedsContext", swigMethodTypes9))
      swigDelegate9 = new SwigDelegateHTK_NURBS_Surface_9(SwigDirectorNeedsContext);
    HCSSTREAMPINVOKE.HTK_NURBS_Surface_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9);
  }

  private bool SwigDerivedClassHasMethod(string methodName, Type[] methodTypes) {
    System.Reflection.MethodInfo methodInfo = this.GetType().GetMethod(methodName, System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance, null, methodTypes, null);
    bool hasDerivedMethod = methodInfo.DeclaringType.IsSubclassOf(typeof(HTK_NURBS_Surface));
  ...
  public delegate int SwigDelegateHTK_NURBS_Surface_0(IntPtr tk);
  public delegate int SwigDelegateHTK_NURBS_Surface_1(IntPtr tk);
  public delegate int SwigDelegateHTK_NURBS_Surface_2(IntPtr tk);
  public delegate int SwigDelegateHTK_NURBS_Surface_3(IntPtr tk, ID_Key key, int variant);
  public delegate int SwigDelegateHTK_NURBS_Surface_4(IntPtr tk, ID_Key key);
  public delegate int SwigDelegateHTK_NURBS_Surface_5(IntPtr tk, ID_Key key, string special);
  public delegate void SwigDelegateHTK_NURBS_Surface_6();
  public delegate bool SwigDelegateHTK_NURBS_Surface_7(IntPtr tk, IntPtr instance);
  public delegate int SwigDelegateHTK_NURBS_Surface_8(IntPtr tk, IntPtr handler);
  public delegate bool SwigDelegateHTK_NURBS_Surface_9(IntPtr tk);

  private SwigDelegateHTK_NURBS_Surface_0 swigDelegate0;
  private SwigDelegateHTK_NURBS_Surface_1 swigDelegate1;
  private SwigDelegateHTK_NURBS_Surface_2 swigDelegate2;
  private SwigDelegateHTK_NURBS_Surface_3 swigDelegate3;
  private SwigDelegateHTK_NURBS_Surface_4 swigDelegate4;
  private SwigDelegateHTK_NURBS_Surface_5 swigDelegate5;
  private SwigDelegateHTK_NURBS_Surface_6 swigDelegate6;
  private SwigDelegateHTK_NURBS_Surface_7 swigDelegate7;
  private SwigDelegateHTK_NURBS_Surface_8 swigDelegate8;
  private SwigDelegateHTK_NURBS_Surface_9 swigDelegate9;
