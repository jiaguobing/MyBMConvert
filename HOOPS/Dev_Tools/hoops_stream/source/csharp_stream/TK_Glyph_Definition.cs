...
public class TK_Glyph_Definition : BBaseOpcodeHandler {
  ...
  public TK_Glyph_Definition(IntPtr cPtr, bool cMemoryOwn) : base(HCSSTREAMPINVOKE.TK_Glyph_DefinitionUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  public static HandleRef getCPtr(TK_Glyph_Definition obj) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          HCSSTREAMPINVOKE.delete_TK_Glyph_Definition(swigCPtr);
        }
  ...
  public TK_Glyph_Definition() : this(HCSSTREAMPINVOKE.new_TK_Glyph_Definition(), true) {
    SwigDirectorConnect();
  }

  public override TK_Status Read(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Glyph_Definition)) ? HCSSTREAMPINVOKE.TK_Glyph_Definition_Read(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSSTREAMPINVOKE.TK_Glyph_Definition_ReadSwigExplicitTK_Glyph_Definition(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
  ...
  public override TK_Status Write(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Glyph_Definition)) ? HCSSTREAMPINVOKE.TK_Glyph_Definition_Write(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSSTREAMPINVOKE.TK_Glyph_Definition_WriteSwigExplicitTK_Glyph_Definition(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override TK_Status Clone(BStreamFileToolkit tk, SWIGTYPE_p_p_BBaseOpcodeHandler handler) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Glyph_Definition)) ? HCSSTREAMPINVOKE.TK_Glyph_Definition_Clone(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)) : HCSSTREAMPINVOKE.TK_Glyph_Definition_CloneSwigExplicitTK_Glyph_Definition(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status ReadAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSSTREAMPINVOKE.TK_Glyph_Definition_ReadAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status WriteAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSSTREAMPINVOKE.TK_Glyph_Definition_WriteAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override void Reset() {
    if (this.GetType() == typeof(TK_Glyph_Definition)) HCSSTREAMPINVOKE.TK_Glyph_Definition_Reset(swigCPtr); else HCSSTREAMPINVOKE.TK_Glyph_Definition_ResetSwigExplicitTK_Glyph_Definition(swigCPtr);
  }

  public void SetName(string name) {
    HCSSTREAMPINVOKE.TK_Glyph_Definition_SetName__SWIG_0(swigCPtr, name);
  }

  public void SetName(int length) {
    HCSSTREAMPINVOKE.TK_Glyph_Definition_SetName__SWIG_1(swigCPtr, length);
  }

  public string GetName() {return HCSSTREAMPINVOKE.TK_Glyph_Definition_GetName__SWIG_0(swigCPtr);}

  public void SetDefinition(int size, string data) {
    HCSSTREAMPINVOKE.TK_Glyph_Definition_SetDefinition__SWIG_0(swigCPtr, size, data);
  }

  public void SetDefinition(int size) {
    HCSSTREAMPINVOKE.TK_Glyph_Definition_SetDefinition__SWIG_1(swigCPtr, size);
  }

  public int GetDefinitionSize() {
    int ret = HCSSTREAMPINVOKE.TK_Glyph_Definition_GetDefinitionSize(swigCPtr);
    return ret;
  }

  public string GetDefinition() {return HCSSTREAMPINVOKE.TK_Glyph_Definition_GetDefinition__SWIG_0(swigCPtr);}
  ...
  private void SwigDirectorConnect() {
    ...
    HCSSTREAMPINVOKE.TK_Glyph_Definition_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9);
  }
  ...
  public delegate int SwigDelegateTK_Glyph_Definition_3(IntPtr tk, ID_Key key, int variant);
  public delegate int SwigDelegateTK_Glyph_Definition_4(IntPtr tk, ID_Key key);
  public delegate int SwigDelegateTK_Glyph_Definition_5(IntPtr tk, ID_Key key, string special);
