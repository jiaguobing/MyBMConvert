...
public class TK_Color_By_Index : BBaseOpcodeHandler {
  ...
  internal TK_Color_By_Index(IntPtr cPtr, bool cMemoryOwn) : base(HCSBSTREAMPINVOKE.TK_Color_By_IndexUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(TK_Color_By_Index obj) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          HCSBSTREAMPINVOKE.delete_TK_Color_By_Index(swigCPtr);
        }
  ...
  public TK_Color_By_Index(byte opcode) : this(HCSBSTREAMPINVOKE.new_TK_Color_By_Index(opcode), true) {
    SwigDirectorConnect();
  }

  public override TK_Status Read(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Color_By_Index)) ? HCSBSTREAMPINVOKE.TK_Color_By_Index_Read(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSBSTREAMPINVOKE.TK_Color_By_Index_ReadSwigExplicitTK_Color_By_Index(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
  ...
  public override TK_Status Write(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Color_By_Index)) ? HCSBSTREAMPINVOKE.TK_Color_By_Index_Write(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSBSTREAMPINVOKE.TK_Color_By_Index_WriteSwigExplicitTK_Color_By_Index(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override TK_Status Clone(BStreamFileToolkit tk, SWIGTYPE_p_p_BBaseOpcodeHandler handler) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Color_By_Index)) ? HCSBSTREAMPINVOKE.TK_Color_By_Index_Clone(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)) : HCSBSTREAMPINVOKE.TK_Color_By_Index_CloneSwigExplicitTK_Color_By_Index(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status ReadAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSBSTREAMPINVOKE.TK_Color_By_Index_ReadAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status WriteAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSBSTREAMPINVOKE.TK_Color_By_Index_WriteAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void SetGeometry(int m) {
    HCSBSTREAMPINVOKE.TK_Color_By_Index_SetGeometry(swigCPtr, m);
  }

  public int GetGeometry() {
    int ret = HCSBSTREAMPINVOKE.TK_Color_By_Index_GetGeometry(swigCPtr);
    return ret;
  }

  public void SetIndex(int i) {
    HCSBSTREAMPINVOKE.TK_Color_By_Index_SetIndex(swigCPtr, i);
  }

  public int GetIndex() {
    int ret = HCSBSTREAMPINVOKE.TK_Color_By_Index_GetIndex(swigCPtr);
    return ret;
  }
  ...
  private void SwigDirectorConnect() {
    ...
    HCSBSTREAMPINVOKE.TK_Color_By_Index_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9);
  }
  ...
  public delegate int SwigDelegateTK_Color_By_Index_3(IntPtr tk, int key, int variant);
  public delegate int SwigDelegateTK_Color_By_Index_4(IntPtr tk, int key);
  public delegate int SwigDelegateTK_Color_By_Index_5(IntPtr tk, int key, string special);
