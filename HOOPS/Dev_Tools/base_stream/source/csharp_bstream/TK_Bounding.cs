...
public class TK_Bounding : BBaseOpcodeHandler {
  ...
  internal TK_Bounding(IntPtr cPtr, bool cMemoryOwn) : base(HCSBSTREAMPINVOKE.TK_BoundingUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(TK_Bounding obj) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          HCSBSTREAMPINVOKE.delete_TK_Bounding(swigCPtr);
        }
  ...
  public TK_Bounding(byte opcode) : this(HCSBSTREAMPINVOKE.new_TK_Bounding__SWIG_0(opcode), true) {
    SwigDirectorConnect();
  }

  public TK_Bounding(byte opcode, float[] min, float[] max) : this(HCSBSTREAMPINVOKE.new_TK_Bounding__SWIG_1(opcode, min, max), true) {
    SwigDirectorConnect();
  }

  public TK_Bounding(byte opcode, float[] center, float radius) : this(HCSBSTREAMPINVOKE.new_TK_Bounding__SWIG_2(opcode, center, radius), true) {
    SwigDirectorConnect();
  }

  public TK_Bounding(byte opcode, double[] min, double[] max) : this(HCSBSTREAMPINVOKE.new_TK_Bounding__SWIG_3(opcode, min, max), true) {
    SwigDirectorConnect();
  }

  public TK_Bounding(byte opcode, double[] center, double radius) : this(HCSBSTREAMPINVOKE.new_TK_Bounding__SWIG_4(opcode, center, radius), true) {
    SwigDirectorConnect();
  }

  public override TK_Status Read(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Bounding)) ? HCSBSTREAMPINVOKE.TK_Bounding_Read(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSBSTREAMPINVOKE.TK_Bounding_ReadSwigExplicitTK_Bounding(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
  ...
  public override TK_Status Write(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Bounding)) ? HCSBSTREAMPINVOKE.TK_Bounding_Write(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSBSTREAMPINVOKE.TK_Bounding_WriteSwigExplicitTK_Bounding(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override TK_Status Clone(BStreamFileToolkit tk, SWIGTYPE_p_p_BBaseOpcodeHandler handler) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Bounding)) ? HCSBSTREAMPINVOKE.TK_Bounding_Clone(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)) : HCSBSTREAMPINVOKE.TK_Bounding_CloneSwigExplicitTK_Bounding(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status ReadAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSBSTREAMPINVOKE.TK_Bounding_ReadAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status WriteAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSBSTREAMPINVOKE.TK_Bounding_WriteAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  private void SwigDirectorConnect() {
    ...
    HCSBSTREAMPINVOKE.TK_Bounding_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9);
  }
  ...
  public delegate int SwigDelegateTK_Bounding_3(IntPtr tk, int key, int variant);
  public delegate int SwigDelegateTK_Bounding_4(IntPtr tk, int key);
  public delegate int SwigDelegateTK_Bounding_5(IntPtr tk, int key, string special);
