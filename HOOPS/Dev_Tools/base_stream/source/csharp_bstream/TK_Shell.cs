...
public class TK_Shell : TK_Polyhedron {
  ...
  internal TK_Shell(IntPtr cPtr, bool cMemoryOwn) : base(HCSBSTREAMPINVOKE.TK_ShellUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(TK_Shell obj) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          HCSBSTREAMPINVOKE.delete_TK_Shell(swigCPtr);
        }
  ...
  protected virtual new TK_Status EnumerateEdges() {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Shell)) ? HCSBSTREAMPINVOKE.TK_Shell_EnumerateEdges(swigCPtr) : HCSBSTREAMPINVOKE.TK_Shell_EnumerateEdgesSwigExplicitTK_Shell(swigCPtr));
    return ret;
  }

  public TK_Shell() : this(HCSBSTREAMPINVOKE.new_TK_Shell(), true) {
    SwigDirectorConnect();
  }

  public void set_flist(int count, int[] list) {
    HCSBSTREAMPINVOKE.TK_Shell_set_flist__SWIG_0(swigCPtr, count, list);
  }

  public void set_flist(int count) {
    HCSBSTREAMPINVOKE.TK_Shell_set_flist__SWIG_1(swigCPtr, count);
  }

  public override TK_Status Read(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Shell)) ? HCSBSTREAMPINVOKE.TK_Shell_Read(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSBSTREAMPINVOKE.TK_Shell_ReadSwigExplicitTK_Shell(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
  ...
  public override TK_Status Write(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Shell)) ? HCSBSTREAMPINVOKE.TK_Shell_Write(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSBSTREAMPINVOKE.TK_Shell_WriteSwigExplicitTK_Shell(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status ReadAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSBSTREAMPINVOKE.TK_Shell_ReadAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status WriteAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSBSTREAMPINVOKE.TK_Shell_WriteAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override void Reset() {
    if (this.GetType() == typeof(TK_Shell)) HCSBSTREAMPINVOKE.TK_Shell_Reset(swigCPtr); else HCSBSTREAMPINVOKE.TK_Shell_ResetSwigExplicitTK_Shell(swigCPtr);
  }
  ...
  public delegate int SwigDelegateTK_Shell_3(IntPtr tk, int key, int variant);
  public delegate int SwigDelegateTK_Shell_4(IntPtr tk, int key);
  public delegate int SwigDelegateTK_Shell_5(IntPtr tk, int key, string special);
