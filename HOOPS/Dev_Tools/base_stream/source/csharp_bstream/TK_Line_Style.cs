...
public class TK_Line_Style : BBaseOpcodeHandler {
  ...
  internal TK_Line_Style(IntPtr cPtr, bool cMemoryOwn) : base(HCSBSTREAMPINVOKE.TK_Line_StyleUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(TK_Line_Style obj) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          HCSBSTREAMPINVOKE.delete_TK_Line_Style(swigCPtr);
        }
  ...
  public TK_Line_Style() : this(HCSBSTREAMPINVOKE.new_TK_Line_Style(), true) {
    SwigDirectorConnect();
  }

  public override TK_Status Read(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Line_Style)) ? HCSBSTREAMPINVOKE.TK_Line_Style_Read(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSBSTREAMPINVOKE.TK_Line_Style_ReadSwigExplicitTK_Line_Style(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
  ...
  public override TK_Status Write(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Line_Style)) ? HCSBSTREAMPINVOKE.TK_Line_Style_Write(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSBSTREAMPINVOKE.TK_Line_Style_WriteSwigExplicitTK_Line_Style(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override TK_Status Clone(BStreamFileToolkit tk, SWIGTYPE_p_p_BBaseOpcodeHandler handler) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Line_Style)) ? HCSBSTREAMPINVOKE.TK_Line_Style_Clone(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)) : HCSBSTREAMPINVOKE.TK_Line_Style_CloneSwigExplicitTK_Line_Style(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status ReadAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSBSTREAMPINVOKE.TK_Line_Style_ReadAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status WriteAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSBSTREAMPINVOKE.TK_Line_Style_WriteAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override void Reset() {
    if (this.GetType() == typeof(TK_Line_Style)) HCSBSTREAMPINVOKE.TK_Line_Style_Reset(swigCPtr); else HCSBSTREAMPINVOKE.TK_Line_Style_ResetSwigExplicitTK_Line_Style(swigCPtr);
  }

  public void SetName(string name) {
    HCSBSTREAMPINVOKE.TK_Line_Style_SetName__SWIG_0(swigCPtr, name);
  }

  public void SetName(int length) {
    HCSBSTREAMPINVOKE.TK_Line_Style_SetName__SWIG_1(swigCPtr, length);
  }

  public string GetName() {return HCSBSTREAMPINVOKE.TK_Line_Style_GetName__SWIG_0(swigCPtr);}

  public void SetDefinition(string def) {
    HCSBSTREAMPINVOKE.TK_Line_Style_SetDefinition__SWIG_0(swigCPtr, def);
  }

  public void SetDefinition(int length) {
    HCSBSTREAMPINVOKE.TK_Line_Style_SetDefinition__SWIG_1(swigCPtr, length);
  }

  public string GetDefinition() {return HCSBSTREAMPINVOKE.TK_Line_Style_GetDefinition__SWIG_0(swigCPtr);}
  ...
  private void SwigDirectorConnect() {
    ...
    HCSBSTREAMPINVOKE.TK_Line_Style_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9);
  }
  ...
  public delegate int SwigDelegateTK_Line_Style_3(IntPtr tk, int key, int variant);
  public delegate int SwigDelegateTK_Line_Style_4(IntPtr tk, int key);
  public delegate int SwigDelegateTK_Line_Style_5(IntPtr tk, int key, string special);
