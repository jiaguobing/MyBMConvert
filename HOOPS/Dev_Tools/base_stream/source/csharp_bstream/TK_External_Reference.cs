...
public class TK_External_Reference : BBaseOpcodeHandler {
  ...
  internal TK_External_Reference(IntPtr cPtr, bool cMemoryOwn) : base(HCSBSTREAMPINVOKE.TK_External_ReferenceUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(TK_External_Reference obj) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          HCSBSTREAMPINVOKE.delete_TK_External_Reference(swigCPtr);
        }
  ...
  public TK_External_Reference() : this(HCSBSTREAMPINVOKE.new_TK_External_Reference(), true) {
    SwigDirectorConnect();
  }

  public override TK_Status Read(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_External_Reference)) ? HCSBSTREAMPINVOKE.TK_External_Reference_Read(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSBSTREAMPINVOKE.TK_External_Reference_ReadSwigExplicitTK_External_Reference(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
  ...
  public override TK_Status Write(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_External_Reference)) ? HCSBSTREAMPINVOKE.TK_External_Reference_Write(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSBSTREAMPINVOKE.TK_External_Reference_WriteSwigExplicitTK_External_Reference(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override TK_Status Clone(BStreamFileToolkit tk, SWIGTYPE_p_p_BBaseOpcodeHandler handler) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_External_Reference)) ? HCSBSTREAMPINVOKE.TK_External_Reference_Clone(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)) : HCSBSTREAMPINVOKE.TK_External_Reference_CloneSwigExplicitTK_External_Reference(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status ReadAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSBSTREAMPINVOKE.TK_External_Reference_ReadAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status WriteAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSBSTREAMPINVOKE.TK_External_Reference_WriteAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override TK_Status Execute(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_External_Reference)) ? HCSBSTREAMPINVOKE.TK_External_Reference_Execute(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSBSTREAMPINVOKE.TK_External_Reference_ExecuteSwigExplicitTK_External_Reference(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override void Reset() {
    if (this.GetType() == typeof(TK_External_Reference)) HCSBSTREAMPINVOKE.TK_External_Reference_Reset(swigCPtr); else HCSBSTREAMPINVOKE.TK_External_Reference_ResetSwigExplicitTK_External_Reference(swigCPtr);
  }

  public void SetString(string arg0) {
    HCSBSTREAMPINVOKE.TK_External_Reference_SetString__SWIG_0(swigCPtr, arg0);
  }

  public void SetString(int length) {
    HCSBSTREAMPINVOKE.TK_External_Reference_SetString__SWIG_1(swigCPtr, length);
  }

  public string GetString() {return HCSBSTREAMPINVOKE.TK_External_Reference_GetString__SWIG_0(swigCPtr);}
  ...
  private void SwigDirectorConnect() {
    ...
    HCSBSTREAMPINVOKE.TK_External_Reference_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9);
  }
  ...
  public delegate int SwigDelegateTK_External_Reference_3(IntPtr tk, int key, int variant);
  public delegate int SwigDelegateTK_External_Reference_4(IntPtr tk, int key);
  public delegate int SwigDelegateTK_External_Reference_5(IntPtr tk, int key, string special);
