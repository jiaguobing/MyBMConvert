...
public class TK_Mesh : TK_Polyhedron {
  ...
  internal TK_Mesh(IntPtr cPtr, bool cMemoryOwn) : base(HCSBSTREAMPINVOKE.TK_MeshUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(TK_Mesh obj) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          HCSBSTREAMPINVOKE.delete_TK_Mesh(swigCPtr);
        }
  ...
  public TK_Mesh() : this(HCSBSTREAMPINVOKE.new_TK_Mesh(), true) {
    SwigDirectorConnect();
  }

  public TK_Status ReadAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSBSTREAMPINVOKE.TK_Mesh_ReadAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status WriteAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSBSTREAMPINVOKE.TK_Mesh_WriteAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override TK_Status Read(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Mesh)) ? HCSBSTREAMPINVOKE.TK_Mesh_Read(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSBSTREAMPINVOKE.TK_Mesh_ReadSwigExplicitTK_Mesh(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override TK_Status Write(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Mesh)) ? HCSBSTREAMPINVOKE.TK_Mesh_Write(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSBSTREAMPINVOKE.TK_Mesh_WriteSwigExplicitTK_Mesh(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override void Reset() {
    if (this.GetType() == typeof(TK_Mesh)) HCSBSTREAMPINVOKE.TK_Mesh_Reset(swigCPtr); else HCSBSTREAMPINVOKE.TK_Mesh_ResetSwigExplicitTK_Mesh(swigCPtr);
  }

  public void SetRows(int rows) {
    HCSBSTREAMPINVOKE.TK_Mesh_SetRows(swigCPtr, rows);
  }

  public void SetColumns(int columns) {
    HCSBSTREAMPINVOKE.TK_Mesh_SetColumns(swigCPtr, columns);
  }
  ...
  public delegate int SwigDelegateTK_Mesh_3(IntPtr tk, int key, int variant);
  public delegate int SwigDelegateTK_Mesh_4(IntPtr tk, int key);
  public delegate int SwigDelegateTK_Mesh_5(IntPtr tk, int key, string special);
