...
public class TK_PolyCylinder : TK_Polyhedron {
  ...
  internal TK_PolyCylinder(IntPtr cPtr, bool cMemoryOwn) : base(HCSBSTREAMPINVOKE.TK_PolyCylinderUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(TK_PolyCylinder obj) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          HCSBSTREAMPINVOKE.delete_TK_PolyCylinder(swigCPtr);
        }
  ...
  public TK_PolyCylinder() : this(HCSBSTREAMPINVOKE.new_TK_PolyCylinder(), true) {
    SwigDirectorConnect();
  }

  public override TK_Status Read(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSBSTREAMPINVOKE.TK_PolyCylinder_Read(swigCPtr, BStreamFileToolkit.getCPtr(tk));
  ...
  public override TK_Status Write(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSBSTREAMPINVOKE.TK_PolyCylinder_Write(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override TK_Status Clone(BStreamFileToolkit tk, SWIGTYPE_p_p_BBaseOpcodeHandler handler) {
    TK_Status ret = (TK_Status)HCSBSTREAMPINVOKE.TK_PolyCylinder_Clone(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status ReadAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSBSTREAMPINVOKE.TK_PolyCylinder_ReadAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status WriteAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSBSTREAMPINVOKE.TK_PolyCylinder_WriteAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override void Reset() {
    if (this.GetType() == typeof(TK_PolyCylinder)) HCSBSTREAMPINVOKE.TK_PolyCylinder_Reset(swigCPtr); else HCSBSTREAMPINVOKE.TK_PolyCylinder_ResetSwigExplicitTK_PolyCylinder(swigCPtr);
  }

  public new void SetPoints(int count, float[] points) {
    HCSBSTREAMPINVOKE.TK_PolyCylinder_SetPoints__SWIG_0(swigCPtr, count, points);
  }

  public new void SetPoints(int count) {
    HCSBSTREAMPINVOKE.TK_PolyCylinder_SetPoints__SWIG_1(swigCPtr, count);
  }

  public new IntPtr GetPoints() {return HCSBSTREAMPINVOKE.TK_PolyCylinder_GetPoints__SWIG_0(swigCPtr);}

  public void SetRadii(int count, float[] radii) {
    HCSBSTREAMPINVOKE.TK_PolyCylinder_SetRadii__SWIG_0(swigCPtr, count, radii);
  }

  public void SetRadii(int count) {
    HCSBSTREAMPINVOKE.TK_PolyCylinder_SetRadii__SWIG_1(swigCPtr, count);
  }

  public void SetRadius(float radius) {
    HCSBSTREAMPINVOKE.TK_PolyCylinder_SetRadius(swigCPtr, radius);
  }

  public IntPtr GetRadii() {return HCSBSTREAMPINVOKE.TK_PolyCylinder_GetRadii__SWIG_0(swigCPtr);}

  public void SetDPoints(int count, double[] points) {
    HCSBSTREAMPINVOKE.TK_PolyCylinder_SetDPoints__SWIG_0(swigCPtr, count, points);
  }

  public void SetDPoints(int count) {
    HCSBSTREAMPINVOKE.TK_PolyCylinder_SetDPoints__SWIG_1(swigCPtr, count);
  }

  public IntPtr GetDPoints() {return HCSBSTREAMPINVOKE.TK_PolyCylinder_GetDPoints__SWIG_0(swigCPtr);}

  public void SetDRadii(int count, double[] radii) {
    HCSBSTREAMPINVOKE.TK_PolyCylinder_SetDRadii__SWIG_0(swigCPtr, count, radii);
  }

  public void SetDRadii(int count) {
    HCSBSTREAMPINVOKE.TK_PolyCylinder_SetDRadii__SWIG_1(swigCPtr, count);
  }

  public void SetDRadius(double radius) {
    HCSBSTREAMPINVOKE.TK_PolyCylinder_SetDRadius(swigCPtr, radius);
  }

  public IntPtr GetDRadii() {return HCSBSTREAMPINVOKE.TK_PolyCylinder_GetDRadii__SWIG_0(swigCPtr);}

  public int GetCount() {
    int ret = HCSBSTREAMPINVOKE.TK_PolyCylinder_GetCount(swigCPtr);
    return ret;
  }

  public int GetRadiusCount() {
    int ret = HCSBSTREAMPINVOKE.TK_PolyCylinder_GetRadiusCount(swigCPtr);
    return ret;
  }

  public void SetCaps(int f) {
    HCSBSTREAMPINVOKE.TK_PolyCylinder_SetCaps(swigCPtr, f);
  }

  public int GetCaps() {
    int ret = HCSBSTREAMPINVOKE.TK_PolyCylinder_GetCaps(swigCPtr);
    return ret;
  }

  public void SetEndNormal(int index, float[] normal) {
    HCSBSTREAMPINVOKE.TK_PolyCylinder_SetEndNormal__SWIG_0(swigCPtr, index, normal);
  }

  public void SetEndNormal(int index) {
    HCSBSTREAMPINVOKE.TK_PolyCylinder_SetEndNormal__SWIG_1(swigCPtr, index);
  }

  public IntPtr GetEndNormal(int index) {return HCSBSTREAMPINVOKE.TK_PolyCylinder_GetEndNormal(swigCPtr, index);}
  ...
  public delegate int SwigDelegateTK_PolyCylinder_3(IntPtr tk, int key, int variant);
  public delegate int SwigDelegateTK_PolyCylinder_4(IntPtr tk, int key);
  public delegate int SwigDelegateTK_PolyCylinder_5(IntPtr tk, int key, string special);
