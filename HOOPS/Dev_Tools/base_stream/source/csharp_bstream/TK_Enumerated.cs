...
public class TK_Enumerated : BBaseOpcodeHandler {
  ...
  internal TK_Enumerated(IntPtr cPtr, bool cMemoryOwn) : base(HCSBSTREAMPINVOKE.TK_EnumeratedUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(TK_Enumerated obj) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          HCSBSTREAMPINVOKE.delete_TK_Enumerated(swigCPtr);
        }
  ...
  public TK_Enumerated(byte opcode) : this(HCSBSTREAMPINVOKE.new_TK_Enumerated(opcode), true) {
    SwigDirectorConnect();
  }

  public override TK_Status Read(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Enumerated)) ? HCSBSTREAMPINVOKE.TK_Enumerated_Read(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSBSTREAMPINVOKE.TK_Enumerated_ReadSwigExplicitTK_Enumerated(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
  ...
  public override TK_Status Write(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Enumerated)) ? HCSBSTREAMPINVOKE.TK_Enumerated_Write(swigCPtr, BStreamFileToolkit.getCPtr(tk)) : HCSBSTREAMPINVOKE.TK_Enumerated_WriteSwigExplicitTK_Enumerated(swigCPtr, BStreamFileToolkit.getCPtr(tk)));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override TK_Status Clone(BStreamFileToolkit tk, SWIGTYPE_p_p_BBaseOpcodeHandler handler) {
    TK_Status ret = (TK_Status)((this.GetType() == typeof(TK_Enumerated)) ? HCSBSTREAMPINVOKE.TK_Enumerated_Clone(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)) : HCSBSTREAMPINVOKE.TK_Enumerated_CloneSwigExplicitTK_Enumerated(swigCPtr, BStreamFileToolkit.getCPtr(tk), SWIGTYPE_p_p_BBaseOpcodeHandler.getCPtr(handler)));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status ReadAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSBSTREAMPINVOKE.TK_Enumerated_ReadAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TK_Status WriteAscii(BStreamFileToolkit tk) {
    TK_Status ret = (TK_Status)HCSBSTREAMPINVOKE.TK_Enumerated_WriteAscii(swigCPtr, BStreamFileToolkit.getCPtr(tk));
    if (HCSBSTREAMPINVOKE.SWIGPendingException.Pending) throw HCSBSTREAMPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void SetIndex(int i) {
    HCSBSTREAMPINVOKE.TK_Enumerated_SetIndex(swigCPtr, i);
  }

  public int GetIndex() {
    int ret = HCSBSTREAMPINVOKE.TK_Enumerated_GetIndex(swigCPtr);
    return ret;
  }
  ...
  private void SwigDirectorConnect() {
    ...
    HCSBSTREAMPINVOKE.TK_Enumerated_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9);
  }
  ...
  public delegate int SwigDelegateTK_Enumerated_3(IntPtr tk, int key, int variant);
  public delegate int SwigDelegateTK_Enumerated_4(IntPtr tk, int key);
  public delegate int SwigDelegateTK_Enumerated_5(IntPtr tk, int key, string special);
