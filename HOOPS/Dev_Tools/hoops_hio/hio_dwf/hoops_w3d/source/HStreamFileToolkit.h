...
class Internal_Segment_Processor : public BBaseOpcodeHandler {
    protected:
		...
		int						m_priority;			/*!< priority of a subsegment */
...
class HBINFILETK_API2 HStreamFileToolkit : public BStreamFileToolkit {
    ...
    private:
		...
		bool							m_local_attributes;		/* flag presence of geometry-level attributes (used in GenerateOne) */
    ...
    public:
        ...
        */
        ...
        /*!
            ...
            \return The result of the function call.
        */
		TK_Status	Write_Stream_File (void);
		...
		*/
		void		ClearExcludedSegments (void);
		/*!
			Gets the current number of keys of excluded segments
			\return number of keys
		*/
		int			GetExcludedSegmentCount (void) const	{ return m_excluded_count;			}
		/*!
			Gets the array of keys of excluded segments
			\return the array of keys of excluded segments
		*/
		HC_KEY const *	GetExcludedSegments (void) const	{ return m_excluded_segments;		}
    ...
    protected:
        ...
        void            read_completed ();
        //! internal use
        void            empty_lists (void);
        //! internal use
        TK_Status       tag (int variant);
        //! internal use
        unsigned long   count_segment_objects (HC_KEY key, char const * start_segment = 0);
};
