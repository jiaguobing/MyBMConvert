...
//
GLTF::MaterialPBR* GLTF::LODBMConvert::GetMaterial(GLTF::BMColor& color, string& texturePath, std::map<std::string, GLTF::Texture*>& vTextureMaps)
{
...
bool GLTF::LODBMConvert::ConvertBMMeshToGLTF()
{
...
//
bool GLTF::LODBMConvert::writeAssetToFile()
{
...
void GLTF::LODBMConvert::freeMemory()
{
	if (m_pAsset != nullptr)
	{
...
//
bool GLTF::LODBMConvert::ConvertGLTFToB3DM()
{
...
bool GLTF::LODBMConvert::ConvertBMMeshToB3DM()
{
	if (!ConvertBMMeshToGLTF()) return false;
	return ConvertGLTFToB3DM();
}
//////////////////////////////////////////////////////////////////////////
bool GLTF::LODBMConvert3DTile::Convert()
{
	...
	m_QuadtreeManager.m_vLODFilePaths = m_vLODFilePaths;
	//
...
void GLTF::LODBMConvert3DTile::ConvertB3DM(LODBMQuadtreeNode* pQuadtreeNode)
{
	if (pQuadtreeNode->m_Invalide)
	{
		LODBMConvert _convert;
...
void GLTF::LODBMConvert3DTile::WriteJSON()
{
...
void GLTF::LODBMConvert3DTile::ComputeRotation(double matrix[16])
{
	//不需要计算旋转矩阵
...
void GLTF::LODBMConvert3DTile::MatrixMultiplyMatrix(double matrixA[16], double matrixB[16], double matrixS[16])
{
...
GLTF::BMVertexDD GLTF::LODBMConvert3DTile::FromRadians(double longitude, double latitude, double height)
{
...
//matrix 右剩 pt
GLTF::BMVertexDD GLTF::LODBMConvert3DTile::MatrixMultiplyVector(BMVertexDD& pt, double matrix[16])
{
	BMVertexDD newPt;
...
void GLTF::LODBMConvert3DTile::EastNorthUpToFixedFrame(BMVertexDD& origin, double matrix[16])
{
